        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('productos.update', $producto) }}" id="productoForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select @error('tipo') is-invalid @enderror" 
                                    ...
                                    <option value="producido" {{ old('tipo', $producto->tipo) == 'producido' ? 'selected' : '' }}>
                                        Producido
                                    </option>
                                    <option value="comprado" {{ old('tipo', $producto->tipo) == 'comprado' ? 'selected' : '' }}>
                                        Comprado
                                    </option>
                                </select>
                                @error('tipo')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select @error('unidad_medida') is-invalid @enderror" 
                                    ...
                                    <option value="kg" {{ old('unidad_medida', $producto->unidad_medida) == 'kg' ? 'selected' : '' }}>
                                        Kilogramo (kg)
                                    </option>
                                    <option value="g" {{ old('unidad_medida', $producto->unidad_medida) == 'g' ? 'selected' : '' }}>
                                        Gramo (g)
                                    </option>
                                    <option value="l" {{ old('unidad_medida', $producto->unidad_medida) == 'l' ? 'selected' : '' }}>
                                        Litro (L)
                                    </option>
                                    <option value="ml" {{ old('unidad_medida', $producto->unidad_medida) == 'ml' ? 'selected' : '' }}>
                                        Mililitro (mL)
                                    </option>
                                </select>
                                @error('unidad_medida')
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <span class="input-group-text unidad-medida">{{ $producto->unidad_medida }}</span>
                            </div>
                            @error('stock')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror

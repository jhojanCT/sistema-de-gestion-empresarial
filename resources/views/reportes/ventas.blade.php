...
<div class="container">
    <div class="card shadow-sm mb-4">
        <div class="card-header bg-primary text-white">
            <h4 class="mb-0"><i class="fas fa-cash-register me-2"></i>Reporte de Ventas</h4>
        </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="p-3 bg-light rounded">
                                <h5 class="text-primary mb-2">Total Ventas</h5>
                                <p class="mb-0 fs-4">
                        ...
                        <div class="col-md-4">
                            <div class="p-3 bg-light rounded">
                                <h5 class="text-success mb-2">Ventas al Contado</h5>
                                <p class="mb-0 fs-4">
                                    <span class="text-muted">Bs</span> 
                        ...
                        <div class="col-md-4">
                            <div class="p-3 bg-light rounded">
                                <h5 class="text-warning mb-2">Ventas a Crédito</h5>
                                <p class="mb-0 fs-4">
                                    <span class="text-muted">Bs</span> 

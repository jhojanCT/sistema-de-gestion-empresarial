                        ...
                        <div class="form-group">
                            ...
                            <select name="materia_prima_molida_id" id="materia_prima_molida_id" class="form-control" required>
                                ...
                                @foreach($materiasPrimas as $mp)
                                    <option value="{{ $mp->id }}">{{ $mp->materiaPrimaFiltrada->nombre }} (Stock: {{ $mp->cantidad }})</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="number" step="0.01" min="0.01" class="form-control" id="cantidad_utilizada" name="cantidad_utilizada" required>
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="number" step="0.01" min="0.01" class="form-control" id="cantidad_producida" name="cantidad_producida" required>

            ...
            <div class="card shadow-sm">
                <div class="card-header bg-white">
                    <div class="d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Editar Materia Prima Sin Filtrar</h5>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('materia-prima-sin-filtrar.update', ['materia_prima_sin_filtrar' => $materiaPrima->id]) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('descripcion') is-invalid @enderror" 
                                      id="descripcion" 
                                      name="descripcion" 
                                      rows="3">{{ old('descripcion', $materiaPrima->descripcion) }}</textarea>
                            @error('descripcion')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
